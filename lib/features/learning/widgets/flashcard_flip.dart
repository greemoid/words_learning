...
class _FlashcardFlipState extends State<FlashcardFlip> with SingleTickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final angle = isHalfway ? (_animation.value - 1) * -3.14159 : _animation.value * 3.14159;
          return Transform(
  ...
  Widget _buildFrontSide() {
    return CardContainer(textTheme: widget.textTheme, text: 'Front Side');
  }

  Widget _buildBackSide() {
    return CardContainer(textTheme: widget.textTheme, text: 'Back Side');
  }
}
