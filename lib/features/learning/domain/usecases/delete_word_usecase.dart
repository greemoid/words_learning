...
class DeleteWordUseCase implements UseCase<void, Word> {
  const DeleteWordUseCase({required WordsRepository repository}) : _repository = repository;

  final WordsRepository _repository;

  @override
  Future<Either<Failure, void>> call(Word params) async {
    return await _repository.deleteWord(params);
  }
}
